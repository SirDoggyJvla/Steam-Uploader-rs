...
fn upload_item_content(ugc: &UGC, published_id: PublishedFileId) {
    ...
    let _upload_handle = ugc
        .start_item_update(steamworks::AppId(108600), published_id)
        .content_path(Path::new("/home/simon/Documents/Repositories/Steam-Uploader-tool/SteamUploader-rs/testMod/Contents/hello-world"))
        .preview_path(Path::new("/home/simon/Documents/Repositories/Steam-Uploader-tool/SteamUploader-rs/testMod/Contents/preview.png"))
        .title("Item title")
